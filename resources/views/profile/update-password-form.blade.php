<x-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        {{ __('Zorg ervoor dat je wachtwoord lang en onvoorspelbaar is om veilig te blijven.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('Bevestiging nieuw wachtwoord') }}" />
