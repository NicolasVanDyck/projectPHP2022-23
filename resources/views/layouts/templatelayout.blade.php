...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #4a8ef7 0%, #d7e8fd 100%);
        }
    </style>
    @livewireStyles
    @vite(['resources/css/app.css', 'resources/js/app.js'])
...
<div class="relative -mt-12 lg:-mt-24 -z-50">
    <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(-4.000000, 76.000000)" fill="#F5F5F5" fill-rule="nonzero">
                <path
...
<footer>
    <div>
        <x-layout.footer class="bottom-0"/>
    </div>
</footer>
@livewireScripts
</body>
