...
<x-slot name="title">Fotobeheer</x-slot>
<x-slot name="description">Op deze pagina kan u als admin foto's beheren.</x-slot>
...
<div class='flex items-center justify-center bg-gradient-to-br px-2 pb-4 mx'>
    <div class='w-full max-w-md  mx-auto bg-white rounded-3xl shadow-xl overflow-hidden'>
        <div class='max-w-md mx-auto'>
            <div class='p-8'>
                <p class='font-bold text-gray-700 text-[22px] leading-7 mb-1'>FOTOBEHEER!</p>
