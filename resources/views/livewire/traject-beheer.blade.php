                        ...
                        <div class="grid grid-cols-3 gap-4 mt-4">
                            @foreach($routes as $route)
                                <div class="bg-gray-100 p-4 rounded-lg cursor-pointer hover:bg-info-200"
                                    ...
                                    <p>{{ round($route->amount_of_km/1000) }} km</p>
                                </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div x-show="openModal"
                    ...
                    <div class="bg-white rounded-lg p-6">
                        ...
                        <div x-show="selectedGroup" class="mt-4">
                            @if ($selectedGroup)
                                <button
                                    class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 border border-blue-700 rounded-md transition-colors duration-300 ease-in-out"
                                    x-on:click="isNestedModalOpen = true"
                                ...
                                <p class="mt-2" x-show="selectedRouteKm">Afstand:
                                    <span>{{ round($selectedRouteKm/1000) }}</span> km
                                </p>
                            @endif
                        </div>
                        ...
                        @if($selectedRoute)
                            ...
                            <div class="mt-4">
                                ...
                                <input type="datetime-local" id="end-datepicker" wire:model="selectedEndDate"
                                       class="form-control mt-1" maxlength="4">
                        ...
                        <button
                            class="mt-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 border border-blue-700 rounded-md transition-colors duration-300 ease-in-out"
                            wire:click="createGroepsrit"
                            :disabled="!selectedGroup || !selectedRoute || !selectedDate || !selectedEndDate">Maak je
                            groepsrit
                        </button>
